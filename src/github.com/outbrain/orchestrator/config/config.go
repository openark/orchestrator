...
type Configuration struct {
	...
	PreferredUnresolvedHostnamePatternForMaster string   // When doing a CHANGE MASTER TO, use the unresolved hostname rather than resovled hostname, if it matches this pattern. Use case is using a VIP or CNAME for master other than the real hostname
...
func NewConfiguration() *Configuration {
	return &Configuration{
		...
		PreferredUnresolvedHostnamePatternForMaster: "",
