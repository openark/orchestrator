...
// ConditionalAccessNamedLocationsNamedLocationItemRequestBuilderGetQueryParameters read-only. Nullable. Returns a collection of the specified named locations.
