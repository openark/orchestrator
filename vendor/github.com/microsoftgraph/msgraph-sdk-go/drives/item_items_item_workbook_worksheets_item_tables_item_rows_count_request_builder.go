...
// ItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilder provides operations to count the resources in the collection.
...
// ItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilderGetQueryParameters get the number of the resource
type ItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilderGetQueryParameters struct {
...
type ItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilderGetQueryParameters
}
// NewItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/rows/$count{?%24search,%24filter}";
...
// NewItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsItemTablesItemRowsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
