...
func NewItemItemsItemSubscriptionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemSubscriptionsRequestBuilder) {
    m := &ItemItemsItemSubscriptionsRequestBuilder{
    }
...
func NewItemItemsItemSubscriptionsRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemSubscriptionsRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemItemsItemSubscriptionsRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *ItemItemsItemSubscriptionsRequestBuilder) Count()(*ItemItemsItemSubscriptionsCountRequestBuilder) {
    return NewItemItemsItemSubscriptionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get the set of subscriptions on the item. Only supported on the root of a drive.
func (m *ItemItemsItemSubscriptionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemSubscriptionsRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.SubscriptionCollectionResponseable, error) {
...
func (m *ItemItemsItemSubscriptionsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemItemsItemSubscriptionsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
