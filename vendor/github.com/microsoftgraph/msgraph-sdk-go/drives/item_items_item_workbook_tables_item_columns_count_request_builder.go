...
// ItemItemsItemWorkbookTablesItemColumnsCountRequestBuilder provides operations to count the resources in the collection.
...
// ItemItemsItemWorkbookTablesItemColumnsCountRequestBuilderGetQueryParameters get the number of the resource
type ItemItemsItemWorkbookTablesItemColumnsCountRequestBuilderGetQueryParameters struct {
...
type ItemItemsItemWorkbookTablesItemColumnsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemItemsItemWorkbookTablesItemColumnsCountRequestBuilderGetQueryParameters
}
...
func NewItemItemsItemWorkbookTablesItemColumnsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookTablesItemColumnsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/$count{?%24search,%24filter}";
...
func (m *ItemItemsItemWorkbookTablesItemColumnsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookTablesItemColumnsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
