...
// ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesCountRequestBuilder provides operations to count the resources in the collection.
...
// ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesCountRequestBuilderGetQueryParameters get the number of the resource
type ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesCountRequestBuilderGetQueryParameters struct {
...
type ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesCountRequestBuilderGetQueryParameters
}
...
func NewItemItemsItemWorkbookWorksheetsItemChartsItemSeriesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/series/$count{?%24search,%24filter}";
...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesCountRequestBuilderGetRequestConfiguration)(*int32, error) {
