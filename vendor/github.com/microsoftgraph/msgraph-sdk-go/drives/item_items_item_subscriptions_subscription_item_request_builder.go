...
func (m *ItemItemsItemSubscriptionsSubscriptionItemRequestBuilder) MicrosoftGraphReauthorize()(*ItemItemsItemSubscriptionsItemMicrosoftGraphReauthorizeRequestBuilder) {
    return NewItemItemsItemSubscriptionsItemMicrosoftGraphReauthorizeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
