...
// ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilder provides operations to count the resources in the collection.
...
// ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilderGetQueryParameters get the number of the resource
type ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilderGetQueryParameters struct {
...
type ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilderGetQueryParameters
}
// NewItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/series/{workbookChartSeries%2Did}/points/$count{?%24search,%24filter}";
...
// NewItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
...
func (m *ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemsItemWorkbookWorksheetsItemChartsItemSeriesItemPointsCountRequestBuilderGetRequestConfiguration)(*int32, error) {
