...
func (m *ItemItemsItemWorkbookTablesItemRowsWorkbookTableRowItemRequestBuilder) MicrosoftGraphRange()(*ItemItemsItemWorkbookTablesItemRowsItemMicrosoftGraphRangeRequestBuilder) {
    return NewItemItemsItemWorkbookTablesItemRowsItemMicrosoftGraphRangeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
