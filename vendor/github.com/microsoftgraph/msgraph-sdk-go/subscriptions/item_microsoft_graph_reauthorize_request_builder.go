...
func NewItemMicrosoftGraphReauthorizeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphReauthorizeRequestBuilder) {
    m := &ItemMicrosoftGraphReauthorizeRequestBuilder{
    }
...
func NewItemMicrosoftGraphReauthorizeRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphReauthorizeRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMicrosoftGraphReauthorizeRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action reauthorize
func (m *ItemMicrosoftGraphReauthorizeRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemMicrosoftGraphReauthorizeRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemMicrosoftGraphReauthorizeRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *ItemMicrosoftGraphReauthorizeRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
