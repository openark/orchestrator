...
func NewItemMembersItemMicrosoftGraphApplicationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersItemMicrosoftGraphApplicationRequestBuilder) {
    m := &ItemMembersItemMicrosoftGraphApplicationRequestBuilder{
    }
...
func NewItemMembersItemMicrosoftGraphApplicationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMembersItemMicrosoftGraphApplicationRequestBuilder) {
    ...
    return NewItemMembersItemMicrosoftGraphApplicationRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the item of type microsoft.graph.directoryObject as microsoft.graph.application
func (m *ItemMembersItemMicrosoftGraphApplicationRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMembersItemMicrosoftGraphApplicationRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Applicationable, error) {
...
func (m *ItemMembersItemMicrosoftGraphApplicationRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ItemMembersItemMicrosoftGraphApplicationRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
