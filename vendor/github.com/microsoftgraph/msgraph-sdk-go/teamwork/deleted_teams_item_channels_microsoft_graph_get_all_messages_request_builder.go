...
func NewDeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesRequestBuilder) {
    m := &DeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesRequestBuilder{
    }
...
func NewDeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesRequestBuilder) {
    ...
    return NewDeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesRequestBuilderInternal(urlParams, requestAdapter)
}
// Get invoke function getAllMessages
func (m *DeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesRequestBuilderGetRequestConfiguration)(DeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesGetAllMessagesResponseable, error) {
...
func (m *DeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsMicrosoftGraphGetAllMessagesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
