...
func NewDeletedTeamsItemChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    m := &DeletedTeamsItemChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder{
    }
...
func NewDeletedTeamsItemChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    ...
    return NewDeletedTeamsItemChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action softDelete
func (m *DeletedTeamsItemChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder) Post(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilderPostRequestConfiguration)(error) {
...
func (m *DeletedTeamsItemChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
