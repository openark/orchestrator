...
func NewDeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    m := &DeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder{
    }
...
func NewDeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    ...
    return NewDeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action softDelete
func (m *DeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder) Post(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilderPostRequestConfiguration)(error) {
...
func (m *DeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemMessagesItemMicrosoftGraphSoftDeleteRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
