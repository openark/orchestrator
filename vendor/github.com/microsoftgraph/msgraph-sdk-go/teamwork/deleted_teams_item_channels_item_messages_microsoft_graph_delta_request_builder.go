...
func NewDeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilder) {
    m := &DeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages/microsoft.graph.delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
...
func NewDeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilder) {
    ...
    return NewDeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilderInternal(urlParams, requestAdapter)
}
// Get invoke function delta
func (m *DeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilderGetRequestConfiguration)(DeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateDeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(DeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaDeltaResponseable), nil
}
// ToGetRequestInformation invoke function delta
func (m *DeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
