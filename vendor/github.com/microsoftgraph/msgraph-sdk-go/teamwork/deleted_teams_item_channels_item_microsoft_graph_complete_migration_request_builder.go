...
func NewDeletedTeamsItemChannelsItemMicrosoftGraphCompleteMigrationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMicrosoftGraphCompleteMigrationRequestBuilder) {
    m := &DeletedTeamsItemChannelsItemMicrosoftGraphCompleteMigrationRequestBuilder{
    }
...
func NewDeletedTeamsItemChannelsItemMicrosoftGraphCompleteMigrationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedTeamsItemChannelsItemMicrosoftGraphCompleteMigrationRequestBuilder) {
    ...
    return NewDeletedTeamsItemChannelsItemMicrosoftGraphCompleteMigrationRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DeletedTeamsItemChannelsItemMicrosoftGraphCompleteMigrationRequestBuilder) Post(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemMicrosoftGraphCompleteMigrationRequestBuilderPostRequestConfiguration)(error) {
...
func (m *DeletedTeamsItemChannelsItemMicrosoftGraphCompleteMigrationRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *DeletedTeamsItemChannelsItemMicrosoftGraphCompleteMigrationRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
