...
func NewItemMicrosoftGraphRemoveGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphRemoveGroupRequestBuilder) {
    m := &ItemMicrosoftGraphRemoveGroupRequestBuilder{
    }
...
func NewItemMicrosoftGraphRemoveGroupRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphRemoveGroupRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMicrosoftGraphRemoveGroupRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action removeGroup
func (m *ItemMicrosoftGraphRemoveGroupRequestBuilder) Post(ctx context.Context, body ItemMicrosoftGraphRemoveGroupRemoveGroupPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphRemoveGroupRequestBuilderPostRequestConfiguration)(ItemMicrosoftGraphRemoveGroupRemoveGroupResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateItemMicrosoftGraphRemoveGroupRemoveGroupResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ItemMicrosoftGraphRemoveGroupRemoveGroupResponseable), nil
}
// ToPostRequestInformation invoke action removeGroup
func (m *ItemMicrosoftGraphRemoveGroupRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemMicrosoftGraphRemoveGroupRemoveGroupPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphRemoveGroupRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
