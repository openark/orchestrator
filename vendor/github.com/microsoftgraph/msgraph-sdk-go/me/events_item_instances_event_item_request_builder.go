...
func (m *EventsItemInstancesEventItemRequestBuilder) AttachmentsById(id string)(*EventsItemInstancesItemAttachmentsAttachmentItemRequestBuilder) {
    ...
    return NewEventsItemInstancesItemAttachmentsAttachmentItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func NewEventsItemInstancesEventItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EventsItemInstancesEventItemRequestBuilder) {
...
func NewEventsItemInstancesEventItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EventsItemInstancesEventItemRequestBuilder) {
    ...
    return NewEventsItemInstancesEventItemRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *EventsItemInstancesEventItemRequestBuilder) ExtensionsById(id string)(*EventsItemInstancesItemExtensionsExtensionItemRequestBuilder) {
    ...
    return NewEventsItemInstancesItemExtensionsExtensionItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func (m *EventsItemInstancesEventItemRequestBuilder) MicrosoftGraphAccept()(*EventsItemInstancesItemMicrosoftGraphAcceptRequestBuilder) {
    return NewEventsItemInstancesItemMicrosoftGraphAcceptRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphCancel provides operations to call the cancel method.
func (m *EventsItemInstancesEventItemRequestBuilder) MicrosoftGraphCancel()(*EventsItemInstancesItemMicrosoftGraphCancelRequestBuilder) {
    return NewEventsItemInstancesItemMicrosoftGraphCancelRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDecline provides operations to call the decline method.
func (m *EventsItemInstancesEventItemRequestBuilder) MicrosoftGraphDecline()(*EventsItemInstancesItemMicrosoftGraphDeclineRequestBuilder) {
    return NewEventsItemInstancesItemMicrosoftGraphDeclineRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDismissReminder provides operations to call the dismissReminder method.
func (m *EventsItemInstancesEventItemRequestBuilder) MicrosoftGraphDismissReminder()(*EventsItemInstancesItemMicrosoftGraphDismissReminderRequestBuilder) {
    return NewEventsItemInstancesItemMicrosoftGraphDismissReminderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphForward provides operations to call the forward method.
func (m *EventsItemInstancesEventItemRequestBuilder) MicrosoftGraphForward()(*EventsItemInstancesItemMicrosoftGraphForwardRequestBuilder) {
    return NewEventsItemInstancesItemMicrosoftGraphForwardRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphSnoozeReminder provides operations to call the snoozeReminder method.
func (m *EventsItemInstancesEventItemRequestBuilder) MicrosoftGraphSnoozeReminder()(*EventsItemInstancesItemMicrosoftGraphSnoozeReminderRequestBuilder) {
    return NewEventsItemInstancesItemMicrosoftGraphSnoozeReminderRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphTentativelyAccept provides operations to call the tentativelyAccept method.
func (m *EventsItemInstancesEventItemRequestBuilder) MicrosoftGraphTentativelyAccept()(*EventsItemInstancesItemMicrosoftGraphTentativelyAcceptRequestBuilder) {
    return NewEventsItemInstancesItemMicrosoftGraphTentativelyAcceptRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *EventsItemInstancesEventItemRequestBuilder) MultiValueExtendedPropertiesById(id string)(*EventsItemInstancesItemMultiValueExtendedPropertiesMultiValueLegacyExtendedPropertyItemRequestBuilder) {
    ...
    return NewEventsItemInstancesItemMultiValueExtendedPropertiesMultiValueLegacyExtendedPropertyItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func (m *EventsItemInstancesEventItemRequestBuilder) SingleValueExtendedPropertiesById(id string)(*EventsItemInstancesItemSingleValueExtendedPropertiesSingleValueLegacyExtendedPropertyItemRequestBuilder) {
    ...
    return NewEventsItemInstancesItemSingleValueExtendedPropertiesSingleValueLegacyExtendedPropertyItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
