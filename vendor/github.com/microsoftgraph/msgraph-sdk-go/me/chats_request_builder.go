...
func (m *ChatsRequestBuilder) MicrosoftGraphGetAllMessages()(*ChatsMicrosoftGraphGetAllMessagesRequestBuilder) {
    return NewChatsMicrosoftGraphGetAllMessagesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
// ToPostRequestInformation create new navigation property to chats for me
