...
func (m *CalendarEventsItemInstancesRequestBuilder) MicrosoftGraphDelta()(*CalendarEventsItemInstancesMicrosoftGraphDeltaRequestBuilder) {
    return NewCalendarEventsItemInstancesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *CalendarEventsItemInstancesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *CalendarEventsItemInstancesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
