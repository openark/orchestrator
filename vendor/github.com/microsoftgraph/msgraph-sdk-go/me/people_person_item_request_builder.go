...
// PeoplePersonItemRequestBuilder provides operations to manage the people property of the microsoft.graph.user entity.
type PeoplePersonItemRequestBuilder struct {
...
// PeoplePersonItemRequestBuilderGetQueryParameters people that are relevant to the user. Read-only. Nullable.
type PeoplePersonItemRequestBuilderGetQueryParameters struct {
    // Select properties to be returned
    Select []string `uriparametername:"%24select"`
}
// PeoplePersonItemRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type PeoplePersonItemRequestBuilderGetRequestConfiguration struct {
    // Request headers
...
// NewPeoplePersonItemRequestBuilder instantiates a new PersonItemRequestBuilder and sets the default values.
...
func (m *PeoplePersonItemRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *PeoplePersonItemRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
