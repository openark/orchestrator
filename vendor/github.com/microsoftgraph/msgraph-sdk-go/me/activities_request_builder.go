...
func (m *ActivitiesRequestBuilder) MicrosoftGraphRecent()(*ActivitiesMicrosoftGraphRecentRequestBuilder) {
    return NewActivitiesMicrosoftGraphRecentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
