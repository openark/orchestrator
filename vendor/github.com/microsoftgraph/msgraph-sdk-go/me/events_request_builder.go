...
func (m *EventsRequestBuilder) Count()(*EventsCountRequestBuilder) {
    return NewEventsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *EventsRequestBuilder) MicrosoftGraphDelta()(*EventsMicrosoftGraphDeltaRequestBuilder) {
    return NewEventsMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
