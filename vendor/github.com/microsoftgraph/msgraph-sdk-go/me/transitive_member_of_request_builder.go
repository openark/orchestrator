...
func (m *TransitiveMemberOfRequestBuilder) MicrosoftGraphApplication()(*TransitiveMemberOfMicrosoftGraphApplicationRequestBuilder) {
    return NewTransitiveMemberOfMicrosoftGraphApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDevice casts the previous resource to device.
func (m *TransitiveMemberOfRequestBuilder) MicrosoftGraphDevice()(*TransitiveMemberOfMicrosoftGraphDeviceRequestBuilder) {
    return NewTransitiveMemberOfMicrosoftGraphDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGroup casts the previous resource to group.
func (m *TransitiveMemberOfRequestBuilder) MicrosoftGraphGroup()(*TransitiveMemberOfMicrosoftGraphGroupRequestBuilder) {
    return NewTransitiveMemberOfMicrosoftGraphGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphOrgContact casts the previous resource to orgContact.
func (m *TransitiveMemberOfRequestBuilder) MicrosoftGraphOrgContact()(*TransitiveMemberOfMicrosoftGraphOrgContactRequestBuilder) {
    return NewTransitiveMemberOfMicrosoftGraphOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *TransitiveMemberOfRequestBuilder) MicrosoftGraphServicePrincipal()(*TransitiveMemberOfMicrosoftGraphServicePrincipalRequestBuilder) {
    return NewTransitiveMemberOfMicrosoftGraphServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *TransitiveMemberOfRequestBuilder) MicrosoftGraphUser()(*TransitiveMemberOfMicrosoftGraphUserRequestBuilder) {
    return NewTransitiveMemberOfMicrosoftGraphUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
