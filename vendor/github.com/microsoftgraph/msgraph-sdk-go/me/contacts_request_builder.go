...
func (m *ContactsRequestBuilder) MicrosoftGraphDelta()(*ContactsMicrosoftGraphDeltaRequestBuilder) {
    return NewContactsMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
