...
func (m *TeamworkRequestBuilder) MicrosoftGraphSendActivityNotification()(*TeamworkMicrosoftGraphSendActivityNotificationRequestBuilder) {
    return NewTeamworkMicrosoftGraphSendActivityNotificationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
