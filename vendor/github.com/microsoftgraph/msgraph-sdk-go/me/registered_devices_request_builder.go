...
func (m *RegisteredDevicesRequestBuilder) MicrosoftGraphAppRoleAssignment()(*RegisteredDevicesMicrosoftGraphAppRoleAssignmentRequestBuilder) {
    return NewRegisteredDevicesMicrosoftGraphAppRoleAssignmentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDevice casts the previous resource to device.
func (m *RegisteredDevicesRequestBuilder) MicrosoftGraphDevice()(*RegisteredDevicesMicrosoftGraphDeviceRequestBuilder) {
    return NewRegisteredDevicesMicrosoftGraphDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphEndpoint casts the previous resource to endpoint.
func (m *RegisteredDevicesRequestBuilder) MicrosoftGraphEndpoint()(*RegisteredDevicesMicrosoftGraphEndpointRequestBuilder) {
    return NewRegisteredDevicesMicrosoftGraphEndpointRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
