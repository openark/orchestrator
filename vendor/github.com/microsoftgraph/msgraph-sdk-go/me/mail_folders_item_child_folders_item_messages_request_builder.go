...
func (m *MailFoldersItemChildFoldersItemMessagesRequestBuilder) MicrosoftGraphDelta()(*MailFoldersItemChildFoldersItemMessagesMicrosoftGraphDeltaRequestBuilder) {
    return NewMailFoldersItemChildFoldersItemMessagesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
