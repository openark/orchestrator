...
func (m *AgreementAcceptancesRequestBuilder) Count()(*AgreementAcceptancesCountRequestBuilder) {
    return NewAgreementAcceptancesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
