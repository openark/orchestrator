...
// JoinedTeamsItemScheduleTimeOffRequestsCountRequestBuilderGetQueryParameters get the number of the resource
type JoinedTeamsItemScheduleTimeOffRequestsCountRequestBuilderGetQueryParameters struct {
...
type JoinedTeamsItemScheduleTimeOffRequestsCountRequestBuilderGetRequestConfiguration struct {
    ...
    QueryParameters *JoinedTeamsItemScheduleTimeOffRequestsCountRequestBuilderGetQueryParameters
}
...
func NewJoinedTeamsItemScheduleTimeOffRequestsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*JoinedTeamsItemScheduleTimeOffRequestsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/timeOffRequests/$count{?%24search,%24filter}";
