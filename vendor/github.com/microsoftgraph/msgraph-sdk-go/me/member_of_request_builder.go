...
func (m *MemberOfRequestBuilder) MicrosoftGraphApplication()(*MemberOfMicrosoftGraphApplicationRequestBuilder) {
    return NewMemberOfMicrosoftGraphApplicationRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphDevice casts the previous resource to device.
func (m *MemberOfRequestBuilder) MicrosoftGraphDevice()(*MemberOfMicrosoftGraphDeviceRequestBuilder) {
    return NewMemberOfMicrosoftGraphDeviceRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphGroup casts the previous resource to group.
func (m *MemberOfRequestBuilder) MicrosoftGraphGroup()(*MemberOfMicrosoftGraphGroupRequestBuilder) {
    return NewMemberOfMicrosoftGraphGroupRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphOrgContact casts the previous resource to orgContact.
func (m *MemberOfRequestBuilder) MicrosoftGraphOrgContact()(*MemberOfMicrosoftGraphOrgContactRequestBuilder) {
    return NewMemberOfMicrosoftGraphOrgContactRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphServicePrincipal casts the previous resource to servicePrincipal.
func (m *MemberOfRequestBuilder) MicrosoftGraphServicePrincipal()(*MemberOfMicrosoftGraphServicePrincipalRequestBuilder) {
    return NewMemberOfMicrosoftGraphServicePrincipalRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphUser casts the previous resource to user.
func (m *MemberOfRequestBuilder) MicrosoftGraphUser()(*MemberOfMicrosoftGraphUserRequestBuilder) {
    return NewMemberOfMicrosoftGraphUserRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
