...
// NewBucketsItemTasksRequestBuilderInternal instantiates a new TasksRequestBuilder and sets the default values.
...
// NewBucketsItemTasksRequestBuilder instantiates a new TasksRequestBuilder and sets the default values.
...
func (m *BucketsItemTasksRequestBuilder) Count()(*BucketsItemTasksCountRequestBuilder) {
    return NewBucketsItemTasksCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
