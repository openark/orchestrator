...
func NewDeletedItemsMicrosoftGraphGroupCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsMicrosoftGraphGroupCountRequestBuilder) {
    m := &DeletedItemsMicrosoftGraphGroupCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directory/deletedItems/microsoft.graph.group/$count{?%24search,%24filter}";
...
func NewDeletedItemsMicrosoftGraphGroupCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsMicrosoftGraphGroupCountRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDeletedItemsMicrosoftGraphGroupCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *DeletedItemsMicrosoftGraphGroupCountRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsMicrosoftGraphGroupCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *DeletedItemsMicrosoftGraphGroupCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DeletedItemsMicrosoftGraphGroupCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
