...
func NewFederationConfigurationsMicrosoftGraphAvailableProviderTypesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FederationConfigurationsMicrosoftGraphAvailableProviderTypesRequestBuilder) {
    m := &FederationConfigurationsMicrosoftGraphAvailableProviderTypesRequestBuilder{
    }
...
func NewFederationConfigurationsMicrosoftGraphAvailableProviderTypesRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FederationConfigurationsMicrosoftGraphAvailableProviderTypesRequestBuilder) {
    ...
    return NewFederationConfigurationsMicrosoftGraphAvailableProviderTypesRequestBuilderInternal(urlParams, requestAdapter)
}
// Get invoke function availableProviderTypes
func (m *FederationConfigurationsMicrosoftGraphAvailableProviderTypesRequestBuilder) Get(ctx context.Context, requestConfiguration *FederationConfigurationsMicrosoftGraphAvailableProviderTypesRequestBuilderGetRequestConfiguration)(FederationConfigurationsMicrosoftGraphAvailableProviderTypesAvailableProviderTypesResponseable, error) {
...
func (m *FederationConfigurationsMicrosoftGraphAvailableProviderTypesRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *FederationConfigurationsMicrosoftGraphAvailableProviderTypesRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
