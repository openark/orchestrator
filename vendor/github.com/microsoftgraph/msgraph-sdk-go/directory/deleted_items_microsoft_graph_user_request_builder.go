...
func NewDeletedItemsMicrosoftGraphUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsMicrosoftGraphUserRequestBuilder) {
    m := &DeletedItemsMicrosoftGraphUserRequestBuilder{
    }
...
func NewDeletedItemsMicrosoftGraphUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsMicrosoftGraphUserRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDeletedItemsMicrosoftGraphUserRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DeletedItemsMicrosoftGraphUserRequestBuilder) Count()(*DeletedItemsMicrosoftGraphUserCountRequestBuilder) {
...
func (m *DeletedItemsMicrosoftGraphUserRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsMicrosoftGraphUserRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UserCollectionResponseable, error) {
...
func (m *DeletedItemsMicrosoftGraphUserRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DeletedItemsMicrosoftGraphUserRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
