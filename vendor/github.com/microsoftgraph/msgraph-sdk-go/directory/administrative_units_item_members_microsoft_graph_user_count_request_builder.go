...
func NewAdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilder) {
    m := &AdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.user/$count{?%24search,%24filter}";
...
func NewAdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the number of the resource
func (m *AdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilderGetRequestConfiguration)(*int32, error) {
...
func (m *AdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
