...
func NewAdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilder) {
    m := &AdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilder{
    }
...
func NewAdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *AdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilder) Count()(*AdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilder) {
    return NewAdministrativeUnitsItemMembersMicrosoftGraphUserCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get get the items of type microsoft.graph.user in the microsoft.graph.directoryObject collection
func (m *AdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.UserCollectionResponseable, error) {
...
func (m *AdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersMicrosoftGraphUserRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
