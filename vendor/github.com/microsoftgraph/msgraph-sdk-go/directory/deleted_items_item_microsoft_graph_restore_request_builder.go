...
func NewDeletedItemsItemMicrosoftGraphRestoreRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsItemMicrosoftGraphRestoreRequestBuilder) {
    m := &DeletedItemsItemMicrosoftGraphRestoreRequestBuilder{
    }
...
func NewDeletedItemsItemMicrosoftGraphRestoreRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsItemMicrosoftGraphRestoreRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDeletedItemsItemMicrosoftGraphRestoreRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *DeletedItemsItemMicrosoftGraphRestoreRequestBuilder) Post(ctx context.Context, requestConfiguration *DeletedItemsItemMicrosoftGraphRestoreRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.DirectoryObjectable, error) {
...
func (m *DeletedItemsItemMicrosoftGraphRestoreRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *DeletedItemsItemMicrosoftGraphRestoreRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
