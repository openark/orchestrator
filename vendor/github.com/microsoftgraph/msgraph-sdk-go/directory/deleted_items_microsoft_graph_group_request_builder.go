...
func NewDeletedItemsMicrosoftGraphGroupRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsMicrosoftGraphGroupRequestBuilder) {
    m := &DeletedItemsMicrosoftGraphGroupRequestBuilder{
    }
...
func NewDeletedItemsMicrosoftGraphGroupRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DeletedItemsMicrosoftGraphGroupRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewDeletedItemsMicrosoftGraphGroupRequestBuilderInternal(urlParams, requestAdapter)
}
// Count provides operations to count the resources in the collection.
func (m *DeletedItemsMicrosoftGraphGroupRequestBuilder) Count()(*DeletedItemsMicrosoftGraphGroupCountRequestBuilder) {
    return NewDeletedItemsMicrosoftGraphGroupCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// Get get the items of type microsoft.graph.group in the microsoft.graph.directoryObject collection
func (m *DeletedItemsMicrosoftGraphGroupRequestBuilder) Get(ctx context.Context, requestConfiguration *DeletedItemsMicrosoftGraphGroupRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.GroupCollectionResponseable, error) {
...
func (m *DeletedItemsMicrosoftGraphGroupRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *DeletedItemsMicrosoftGraphGroupRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
