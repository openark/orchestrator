...
func NewAdministrativeUnitsItemMembersItemMicrosoftGraphApplicationRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersItemMicrosoftGraphApplicationRequestBuilder) {
    m := &AdministrativeUnitsItemMembersItemMicrosoftGraphApplicationRequestBuilder{
    }
...
func NewAdministrativeUnitsItemMembersItemMicrosoftGraphApplicationRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AdministrativeUnitsItemMembersItemMicrosoftGraphApplicationRequestBuilder) {
    ...
    return NewAdministrativeUnitsItemMembersItemMicrosoftGraphApplicationRequestBuilderInternal(urlParams, requestAdapter)
}
// Get get the item of type microsoft.graph.directoryObject as microsoft.graph.application
func (m *AdministrativeUnitsItemMembersItemMicrosoftGraphApplicationRequestBuilder) Get(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersItemMicrosoftGraphApplicationRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.Applicationable, error) {
...
func (m *AdministrativeUnitsItemMembersItemMicrosoftGraphApplicationRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *AdministrativeUnitsItemMembersItemMicrosoftGraphApplicationRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
