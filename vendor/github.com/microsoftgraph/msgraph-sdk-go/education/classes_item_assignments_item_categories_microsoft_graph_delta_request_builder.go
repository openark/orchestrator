...
func NewClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder) {
    m := &ClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder{
    }
...
func NewClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder) {
    ...
    return NewClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilderInternal(urlParams, requestAdapter)
}
// Get invoke function delta
func (m *ClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *ClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilderGetRequestConfiguration)(ClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponseable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, CreateClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaDeltaResponseable), nil
}
// ToGetRequestInformation invoke function delta
func (m *ClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *ClassesItemAssignmentsItemCategoriesMicrosoftGraphDeltaRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
