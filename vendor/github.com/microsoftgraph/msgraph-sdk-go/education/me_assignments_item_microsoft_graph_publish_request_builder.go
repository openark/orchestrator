...
func NewMeAssignmentsItemMicrosoftGraphPublishRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MeAssignmentsItemMicrosoftGraphPublishRequestBuilder) {
    m := &MeAssignmentsItemMicrosoftGraphPublishRequestBuilder{
    }
...
func NewMeAssignmentsItemMicrosoftGraphPublishRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MeAssignmentsItemMicrosoftGraphPublishRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewMeAssignmentsItemMicrosoftGraphPublishRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *MeAssignmentsItemMicrosoftGraphPublishRequestBuilder) Post(ctx context.Context, requestConfiguration *MeAssignmentsItemMicrosoftGraphPublishRequestBuilderPostRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.EducationAssignmentable, error) {
...
func (m *MeAssignmentsItemMicrosoftGraphPublishRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *MeAssignmentsItemMicrosoftGraphPublishRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
