...
func (m *MeAssignmentsRequestBuilder) MicrosoftGraphDelta()(*MeAssignmentsMicrosoftGraphDeltaRequestBuilder) {
    return NewMeAssignmentsMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
