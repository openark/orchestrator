...
func NewItemMicrosoftGraphMarkChatReadForUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphMarkChatReadForUserRequestBuilder) {
    m := &ItemMicrosoftGraphMarkChatReadForUserRequestBuilder{
    }
...
func NewItemMicrosoftGraphMarkChatReadForUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphMarkChatReadForUserRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMicrosoftGraphMarkChatReadForUserRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMicrosoftGraphMarkChatReadForUserRequestBuilder) Post(ctx context.Context, body ItemMicrosoftGraphMarkChatReadForUserMarkChatReadForUserPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphMarkChatReadForUserRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemMicrosoftGraphMarkChatReadForUserRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemMicrosoftGraphMarkChatReadForUserMarkChatReadForUserPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphMarkChatReadForUserRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
