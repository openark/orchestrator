...
func NewItemInstalledAppsItemMicrosoftGraphUpgradeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInstalledAppsItemMicrosoftGraphUpgradeRequestBuilder) {
    m := &ItemInstalledAppsItemMicrosoftGraphUpgradeRequestBuilder{
    }
...
func NewItemInstalledAppsItemMicrosoftGraphUpgradeRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemInstalledAppsItemMicrosoftGraphUpgradeRequestBuilder) {
    ...
    return NewItemInstalledAppsItemMicrosoftGraphUpgradeRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemInstalledAppsItemMicrosoftGraphUpgradeRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemInstalledAppsItemMicrosoftGraphUpgradeRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemInstalledAppsItemMicrosoftGraphUpgradeRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *ItemInstalledAppsItemMicrosoftGraphUpgradeRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
