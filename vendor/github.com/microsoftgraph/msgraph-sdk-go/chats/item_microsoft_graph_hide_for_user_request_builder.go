...
func NewItemMicrosoftGraphHideForUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphHideForUserRequestBuilder) {
    m := &ItemMicrosoftGraphHideForUserRequestBuilder{
    }
...
func NewItemMicrosoftGraphHideForUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphHideForUserRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMicrosoftGraphHideForUserRequestBuilderInternal(urlParams, requestAdapter)
}
// Post hide a chat for a user.
// [Find more info here]
// 
// [Find more info here]: https://docs.microsoft.com/graph/api/chat-hideforuser?view=graph-rest-1.0
func (m *ItemMicrosoftGraphHideForUserRequestBuilder) Post(ctx context.Context, body ItemMicrosoftGraphHideForUserHideForUserPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphHideForUserRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemMicrosoftGraphHideForUserRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemMicrosoftGraphHideForUserHideForUserPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphHideForUserRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
