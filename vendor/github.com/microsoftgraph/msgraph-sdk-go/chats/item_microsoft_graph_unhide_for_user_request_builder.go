...
func NewItemMicrosoftGraphUnhideForUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphUnhideForUserRequestBuilder) {
    m := &ItemMicrosoftGraphUnhideForUserRequestBuilder{
    }
...
func NewItemMicrosoftGraphUnhideForUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphUnhideForUserRequestBuilder) {
    urlParams := make(map[string]string)
    urlParams["request-raw-url"] = rawUrl
    return NewItemMicrosoftGraphUnhideForUserRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMicrosoftGraphUnhideForUserRequestBuilder) Post(ctx context.Context, body ItemMicrosoftGraphUnhideForUserUnhideForUserPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphUnhideForUserRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemMicrosoftGraphUnhideForUserRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemMicrosoftGraphUnhideForUserUnhideForUserPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphUnhideForUserRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
