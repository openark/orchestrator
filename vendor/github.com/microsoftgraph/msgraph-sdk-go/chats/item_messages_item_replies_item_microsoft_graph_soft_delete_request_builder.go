...
func NewItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    m := &ItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder{
    }
...
func NewItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder) {
    ...
    return NewItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilderInternal(urlParams, requestAdapter)
}
// Post invoke action softDelete
func (m *ItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder) Post(ctx context.Context, requestConfiguration *ItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilder) ToPostRequestInformation(ctx context.Context, requestConfiguration *ItemMessagesItemRepliesItemMicrosoftGraphSoftDeleteRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
