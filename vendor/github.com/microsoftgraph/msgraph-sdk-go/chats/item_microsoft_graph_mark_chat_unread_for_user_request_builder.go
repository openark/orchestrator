...
func NewItemMicrosoftGraphMarkChatUnreadForUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphMarkChatUnreadForUserRequestBuilder) {
    m := &ItemMicrosoftGraphMarkChatUnreadForUserRequestBuilder{
    }
...
func NewItemMicrosoftGraphMarkChatUnreadForUserRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphMarkChatUnreadForUserRequestBuilder) {
    ...
    return NewItemMicrosoftGraphMarkChatUnreadForUserRequestBuilderInternal(urlParams, requestAdapter)
}
...
func (m *ItemMicrosoftGraphMarkChatUnreadForUserRequestBuilder) Post(ctx context.Context, body ItemMicrosoftGraphMarkChatUnreadForUserMarkChatUnreadForUserPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphMarkChatUnreadForUserRequestBuilderPostRequestConfiguration)(error) {
...
func (m *ItemMicrosoftGraphMarkChatUnreadForUserRequestBuilder) ToPostRequestInformation(ctx context.Context, body ItemMicrosoftGraphMarkChatUnreadForUserMarkChatUnreadForUserPostRequestBodyable, requestConfiguration *ItemMicrosoftGraphMarkChatUnreadForUserRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
