...
// EntitlementManagementAssignmentPoliciesItemQuestionsRequestBuilderGetQueryParameters get questions from identityGovernance
...
// NewEntitlementManagementAssignmentPoliciesItemQuestionsRequestBuilderInternal instantiates a new QuestionsRequestBuilder and sets the default values.
func NewEntitlementManagementAssignmentPoliciesItemQuestionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementAssignmentPoliciesItemQuestionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/assignmentPolicies/{accessPackageAssignmentPolicy%2Did}/questions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
...
// NewEntitlementManagementAssignmentPoliciesItemQuestionsRequestBuilder instantiates a new QuestionsRequestBuilder and sets the default values.
...
func (m *EntitlementManagementAssignmentPoliciesItemQuestionsRequestBuilder) Count()(*EntitlementManagementAssignmentPoliciesItemQuestionsCountRequestBuilder) {
    return NewEntitlementManagementAssignmentPoliciesItemQuestionsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
