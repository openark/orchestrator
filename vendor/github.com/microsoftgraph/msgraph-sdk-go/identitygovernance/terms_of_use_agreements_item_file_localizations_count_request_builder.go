...
// NewTermsOfUseAgreementsItemFileLocalizationsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewTermsOfUseAgreementsItemFileLocalizationsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TermsOfUseAgreementsItemFileLocalizationsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/file/localizations/$count{?%24search,%24filter}";
...
// NewTermsOfUseAgreementsItemFileLocalizationsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
