...
// NewEntitlementManagementAccessPackagesCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewEntitlementManagementAccessPackagesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementAccessPackagesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/$count{?%24search,%24filter}";
...
// NewEntitlementManagementAccessPackagesCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
