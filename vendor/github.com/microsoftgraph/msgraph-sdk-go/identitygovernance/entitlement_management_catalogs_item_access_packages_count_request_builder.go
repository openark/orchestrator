...
// NewEntitlementManagementCatalogsItemAccessPackagesCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewEntitlementManagementCatalogsItemAccessPackagesCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*EntitlementManagementCatalogsItemAccessPackagesCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/accessPackages/$count{?%24search,%24filter}";
...
// NewEntitlementManagementCatalogsItemAccessPackagesCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
