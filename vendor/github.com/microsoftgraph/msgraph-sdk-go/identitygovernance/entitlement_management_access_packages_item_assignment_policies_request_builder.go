...
// EntitlementManagementAccessPackagesItemAssignmentPoliciesRequestBuilderGetQueryParameters get assignmentPolicies from identityGovernance
...
// NewEntitlementManagementAccessPackagesItemAssignmentPoliciesRequestBuilderInternal instantiates a new AssignmentPoliciesRequestBuilder and sets the default values.
...
// NewEntitlementManagementAccessPackagesItemAssignmentPoliciesRequestBuilder instantiates a new AssignmentPoliciesRequestBuilder and sets the default values.
...
func (m *EntitlementManagementAccessPackagesItemAssignmentPoliciesRequestBuilder) Count()(*EntitlementManagementAccessPackagesItemAssignmentPoliciesCountRequestBuilder) {
    return NewEntitlementManagementAccessPackagesItemAssignmentPoliciesCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
