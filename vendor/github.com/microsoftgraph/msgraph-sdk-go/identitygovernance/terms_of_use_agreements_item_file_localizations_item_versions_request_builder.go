...
// TermsOfUseAgreementsItemFileLocalizationsItemVersionsRequestBuilderGetQueryParameters read-only. Customized versions of the terms of use agreement in the Azure AD tenant.
...
// NewTermsOfUseAgreementsItemFileLocalizationsItemVersionsRequestBuilderInternal instantiates a new VersionsRequestBuilder and sets the default values.
