...
func (m *ItemJoinedTeamsItemChannelsItemMessagesRequestBuilder) MicrosoftGraphDelta()(*ItemJoinedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilder) {
    return NewItemJoinedTeamsItemChannelsItemMessagesMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
