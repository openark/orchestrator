...
func (m *ItemOnlineMeetingsRequestBuilder) MicrosoftGraphCreateOrGet()(*ItemOnlineMeetingsMicrosoftGraphCreateOrGetRequestBuilder) {
    return NewItemOnlineMeetingsMicrosoftGraphCreateOrGetRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
