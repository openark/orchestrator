...
func (m *ItemContactFoldersItemContactsRequestBuilder) MicrosoftGraphDelta()(*ItemContactFoldersItemContactsMicrosoftGraphDeltaRequestBuilder) {
    return NewItemContactFoldersItemContactsMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
