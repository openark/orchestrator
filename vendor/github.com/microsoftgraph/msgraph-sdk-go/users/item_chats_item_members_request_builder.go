...
func (m *ItemChatsItemMembersRequestBuilder) MicrosoftGraphAdd()(*ItemChatsItemMembersMicrosoftGraphAddRequestBuilder) {
    return NewItemChatsItemMembersMicrosoftGraphAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
