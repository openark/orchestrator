...
func NewServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponse()(*ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponse) {
    m := &ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponse{
    }
...
func CreateServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponse(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponse) GetValue()(*bool) {
    return m.value
}
// Serialize serializes information the current object
func (m *ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetValue sets the value property value. The value property
func (m *ServiceAnnouncementMessagesMicrosoftGraphUnarchiveUnarchiveResponse) SetValue(value *bool)() {
    m.value = value
}
