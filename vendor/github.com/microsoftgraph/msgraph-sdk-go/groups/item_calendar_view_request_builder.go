...
func (m *ItemCalendarViewRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarViewMicrosoftGraphDeltaRequestBuilder) {
    return NewItemCalendarViewMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
