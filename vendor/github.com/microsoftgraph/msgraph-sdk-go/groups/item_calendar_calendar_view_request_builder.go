...
func (m *ItemCalendarCalendarViewRequestBuilder) MicrosoftGraphDelta()(*ItemCalendarCalendarViewMicrosoftGraphDeltaRequestBuilder) {
    return NewItemCalendarCalendarViewMicrosoftGraphDeltaRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
