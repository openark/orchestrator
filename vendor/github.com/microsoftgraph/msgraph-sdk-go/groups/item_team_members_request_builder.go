...
func (m *ItemTeamMembersRequestBuilder) MicrosoftGraphAdd()(*ItemTeamMembersMicrosoftGraphAddRequestBuilder) {
    return NewItemTeamMembersMicrosoftGraphAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
