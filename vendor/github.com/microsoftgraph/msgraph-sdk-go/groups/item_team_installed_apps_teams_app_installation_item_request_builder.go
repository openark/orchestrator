...
func (m *ItemTeamInstalledAppsTeamsAppInstallationItemRequestBuilder) MicrosoftGraphUpgrade()(*ItemTeamInstalledAppsItemMicrosoftGraphUpgradeRequestBuilder) {
    return NewItemTeamInstalledAppsItemMicrosoftGraphUpgradeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
