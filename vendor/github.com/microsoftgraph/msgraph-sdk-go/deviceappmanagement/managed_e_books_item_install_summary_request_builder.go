...
// NewManagedEBooksItemInstallSummaryRequestBuilder instantiates a new InstallSummaryRequestBuilder and sets the default values.
...
func (m *ManagedEBooksItemInstallSummaryRequestBuilder) Get(ctx context.Context, requestConfiguration *ManagedEBooksItemInstallSummaryRequestBuilderGetRequestConfiguration)(iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.EBookInstallSummaryable, error) {
    ...
    res, err := m.requestAdapter.Send(ctx, requestInfo, iadcd81124412c61e647227ecfc4449d8bba17de0380ddda76f641a29edf2b242.CreateEBookInstallSummaryFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
