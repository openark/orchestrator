...
func (m *ItemMembersRequestBuilder) MicrosoftGraphAdd()(*ItemMembersMicrosoftGraphAddRequestBuilder) {
    return NewItemMembersMicrosoftGraphAddRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
