...
// ToDeleteRequestInformation delete navigation property appointments for solutions
...
// ToPatchRequestInformation update the navigation property appointments in solutions
