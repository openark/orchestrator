...
// ItemTermStoresItemSetsItemParentGroupSetsRequestBuilderGetQueryParameters get a list of the set objects and their properties.
...
// NewItemTermStoresItemSetsItemParentGroupSetsRequestBuilderInternal instantiates a new SetsRequestBuilder and sets the default values.
...
// NewItemTermStoresItemSetsItemParentGroupSetsRequestBuilder instantiates a new SetsRequestBuilder and sets the default values.
...
func (m *ItemTermStoresItemSetsItemParentGroupSetsRequestBuilder) Count()(*ItemTermStoresItemSetsItemParentGroupSetsCountRequestBuilder) {
    return NewItemTermStoresItemSetsItemParentGroupSetsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
