...
// NewItemTermStoresItemSetsItemTermsItemRelationsRequestBuilderInternal instantiates a new RelationsRequestBuilder and sets the default values.
...
// NewItemTermStoresItemSetsItemTermsItemRelationsRequestBuilder instantiates a new RelationsRequestBuilder and sets the default values.
...
func (m *ItemTermStoresItemSetsItemTermsItemRelationsRequestBuilder) Count()(*ItemTermStoresItemSetsItemTermsItemRelationsCountRequestBuilder) {
    return NewItemTermStoresItemSetsItemTermsItemRelationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
