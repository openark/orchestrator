...
// NewItemTermStoresItemSetsItemParentGroupSetsItemTermsRequestBuilderInternal instantiates a new TermsRequestBuilder and sets the default values.
...
// NewItemTermStoresItemSetsItemParentGroupSetsItemTermsRequestBuilder instantiates a new TermsRequestBuilder and sets the default values.
...
func (m *ItemTermStoresItemSetsItemParentGroupSetsItemTermsRequestBuilder) Count()(*ItemTermStoresItemSetsItemParentGroupSetsItemTermsCountRequestBuilder) {
    return NewItemTermStoresItemSetsItemParentGroupSetsItemTermsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
