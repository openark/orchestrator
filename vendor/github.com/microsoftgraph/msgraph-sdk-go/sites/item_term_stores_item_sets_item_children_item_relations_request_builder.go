...
// NewItemTermStoresItemSetsItemChildrenItemRelationsRequestBuilderInternal instantiates a new RelationsRequestBuilder and sets the default values.
...
// NewItemTermStoresItemSetsItemChildrenItemRelationsRequestBuilder instantiates a new RelationsRequestBuilder and sets the default values.
...
func (m *ItemTermStoresItemSetsItemChildrenItemRelationsRequestBuilder) Count()(*ItemTermStoresItemSetsItemChildrenItemRelationsCountRequestBuilder) {
    return NewItemTermStoresItemSetsItemChildrenItemRelationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
