...
// NewItemTermStoresItemSetsItemParentGroupSetsItemRelationsRequestBuilderInternal instantiates a new RelationsRequestBuilder and sets the default values.
...
// NewItemTermStoresItemSetsItemParentGroupSetsItemRelationsRequestBuilder instantiates a new RelationsRequestBuilder and sets the default values.
...
func (m *ItemTermStoresItemSetsItemParentGroupSetsItemRelationsRequestBuilder) Count()(*ItemTermStoresItemSetsItemParentGroupSetsItemRelationsCountRequestBuilder) {
    return NewItemTermStoresItemSetsItemParentGroupSetsItemRelationsCountRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
