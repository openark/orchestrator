...
func (m *ItemListsItemItemsItemDocumentSetVersionsDocumentSetVersionItemRequestBuilder) MicrosoftGraphRestore()(*ItemListsItemItemsItemDocumentSetVersionsItemMicrosoftGraphRestoreRequestBuilder) {
    return NewItemListsItemItemsItemDocumentSetVersionsItemMicrosoftGraphRestoreRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
