...
func (m *ItemOnenotePagesOnenotePageItemRequestBuilder) MicrosoftGraphCopyToSection()(*ItemOnenotePagesItemMicrosoftGraphCopyToSectionRequestBuilder) {
    return NewItemOnenotePagesItemMicrosoftGraphCopyToSectionRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphOnenotePatchContent provides operations to call the onenotePatchContent method.
func (m *ItemOnenotePagesOnenotePageItemRequestBuilder) MicrosoftGraphOnenotePatchContent()(*ItemOnenotePagesItemMicrosoftGraphOnenotePatchContentRequestBuilder) {
    return NewItemOnenotePagesItemMicrosoftGraphOnenotePatchContentRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// MicrosoftGraphPreview provides operations to call the preview method.
func (m *ItemOnenotePagesOnenotePageItemRequestBuilder) MicrosoftGraphPreview()(*ItemOnenotePagesItemMicrosoftGraphPreviewRequestBuilder) {
    return NewItemOnenotePagesItemMicrosoftGraphPreviewRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
