function visualizeInstances(nodesMap, onNodeWrapper) {
    nodesList = []
    ...
    function update(source) {
        ...
        var fo = nodeEnter.append("g").attr("class", "nodeWrapper").attr("data-fo-id", function (d) {
            return d.id
        ...
        $("g.nodeWrapper").each(function() {
        	onNodeWrapper(this, nodesMap);
        }) 	
